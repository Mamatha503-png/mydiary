...
import com.twg.spring.mydiary.business.EntryBusinessInterfaceImpl;
...
public class HomeController {
	...
	@Autowired
	private EntryBusinessInterfaceImpl entryBusinessInterface;
	
	

	public EntryBusinessInterfaceImpl getEntryBusinessInterface() {
		return entryBusinessInterface;
	}
	public void setEntryBusinessInterface(EntryBusinessInterfaceImpl entryBusinessInterface) {
	...
	public ModelAndView saveuser(@ModelAttribute("user") User user) {        //key value pair
	...
	public ModelAndView authenticateuser(@ModelAttribute("user") User user) {
		...
		User user1 = userBusinessInterface.findByUseName(user.getUsername()); //user1 that is from database
